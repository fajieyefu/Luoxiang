...
public class StockContractInputActivity extends BaseActivity  {
...
//                dialog = new Dialog(StockContractInputActivity.this);
//                View view = LayoutInflater.from(StockContractInputActivity.this).inflate(R.layout.more_layout, null);
//                TextView commit = (TextView) view.findViewById(R.id.commit);
//                TextView modify = (TextView) view.findViewById(R.id.modify);
//                modify.setVisibility(View.INVISIBLE);
//                commit.setOnClickListener(StockContractInputActivity.this);
//                modify.setOnClickListener(StockContractInputActivity.this);
...
//        list_height = Arrays.asList(new String[]{"1.4", "1.5", "1.6", "1.7", "1.8", "1.9", "2.0"});
//        ;
//        list_model = Arrays.asList(new String[]{"鹅", "直"});
//        list_powerType = Arrays.asList(new String[]{"汽油", "柴油"});
//
...
//                .url(CommonData.CommitStockContract)
...
//            Toast.makeText(StockContractInputActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
//        }
//
//        @Override
...
//                Toast.makeText(StockContractInputActivity.this, "操作成功！", Toast.LENGTH_SHORT).show();
//                finish();
//            } else {
//                Toast.makeText(StockContractInputActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
}
