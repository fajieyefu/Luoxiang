...
public class SpinnerAdapterForInventory extends BaseAdapter {
    private List<Inventory> data;
    private Context context;

    public SpinnerAdapterForInventory(List<Inventory> data, Context context) {
        this.data = data;
