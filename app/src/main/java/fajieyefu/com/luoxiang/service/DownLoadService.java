...
public class DownLoadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try{
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), R.string.downFail,Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)) {
                ...
                if(manager.getUriForDownloadedFile(downId)!=null){
                    ...
                    Toast.makeText(context,R.string.downFail,Toast.LENGTH_SHORT).show();
                }
    ...
    public void openFile(File var0, Context var1) {
        ...
        try {
            ...
            Toast.makeText(var1, R.string.nofile, Toast.LENGTH_SHORT).show();
        }
    }
