...
public class MySpinnerForRegion extends LinearLayout {
    TextView spinnerText;
    private SpinnerAdapterForRegion spinnerAdapter;
    ...
    private List<Region>  editData = new ArrayList<>();
    private int[] screenWH;


    public MySpinnerForRegion(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        private class MyOnClickListener implements OnClickListener {
            ...
            spinnerAdapter = new SpinnerAdapterForRegion(editData,context);
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    selected_code=editData.get(position).getCodeID();
                    parentCode=editData.get(position).getParentID();
