...
public class MySpinnerForFreeInventory extends LinearLayout {
    ...
    private boolean noSelect_flag = true;



    public MySpinnerForFreeInventory(Context context, AttributeSet attrs) {
        super(context, attrs);
