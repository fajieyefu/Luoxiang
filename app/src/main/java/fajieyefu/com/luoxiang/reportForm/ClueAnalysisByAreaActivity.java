...
import fajieyefu.com.luoxiang.charts.LineCharts;
...
public class ClueAnalysisByAreaActivity extends BaseActivity implements View.OnClickListener {
    @BindView(R.id.title)
    TitleLayout title;
    ...
    private void initData() {
        ...
        OkHttpUtils.postString()
                .url(CommonData.getClueDataByArea)
    ...
    private void initView() {
        ...
        title.setTitleText("大区跟进电话信息情况分析");
    ...
    private class ResponseCallBack extends MyCallback {
        ...
        public void onError(Call call, Exception e, int id) {
            Toast.makeText(ClueAnalysisByAreaActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        ...
        public void onResponse(ReponseBean response, int id) {
            if (response.getCode() == 0) {
                ...
                clueAnalysisAdapter = new ClueAnalysisAdapter(ClueAnalysisByAreaActivity.this, clueData);
                ...
                Toast.makeText(ClueAnalysisByAreaActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
            }
